        ...
        <div class="border border-sky bg-light/20 rounded-2xl w-[600px] m-auto mt-20 p-10">
            <form @submit.prevent class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-1 -mt-4">
                    ...
                    <input type="password" id="password" autocomplete="new-password"
                        class="rounded-md px-3 py-2 focus:ring-1 outline-none focus:ring-sky focus:ring-opacity-50 border border-[#bdc6d7]">
                    <small v-if="false" class="text-xs font-mulish text-red-500">Passwords do not match</small>
                </div>
                <div>
                    <button type="submit"
                        class="bg-peach w-full text-white rounded-md px-3 py-2 hover:bg-peach/90 transition-colors duration-300 ease-in-out">Sign
                        Up</button>
                </div>
                ...
                <p class="text-center text-sm font-mono mt-1">
                    Already have an account? <NuxtLink to="/auth/login" class="text-dark font-bold hover:underline">Login</NuxtLink>
                </p>
            </form>
        </div>
    </div>
