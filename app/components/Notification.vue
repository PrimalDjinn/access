...
onMounted(() => setTimeout(close, props.timeout))
</script>

<template>
  <div ref="notification"
    class="flex items-center justify-between rounded-md p-4 fixed top-24 left-1/2 transform -translate-x-1/2 w-1/3 min-w-96 backdrop-blur"
    :class="intensity">
